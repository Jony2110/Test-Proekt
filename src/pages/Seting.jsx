    ...
    <div className="p-6 flex-1 bg-gray-50">
      ...
      <form className="p-6 rounded-lg space-y-4">
        ...
        <div
          ...
          className="w-[34.75rem] max-w-md border-2 border-gray-300 rounded-lg flex flex-col items-center justify-center text-center cursor-pointer relative"
        >
          <div className="text-gray-400 mb-4">
            <img className="mt-5" src="./img/InputFileLogo.svg" alt="Upload Logo" />
          </div>
          <p className="text-gray-500">Click to upload or drag and drop</p>
          <p className="text-gray-400 mb-5 text-sm">SVG, PNG, JPG or GIF (max, 800x400px)</p>
          <input
            ref={fileInputRef}
            type="file"
          ...
          />
          {selectedFile && (
            <p className="text-green-500 mt-2">Selected file: {selectedFile.name}</p>
          )}
        </div>

...
const Seting = () => {
  return (
    <div className="p-6 flex-1 bg-gray-50">
      ...
      <h2 className="text-3xl font-semibold mb-4 ml-56">Settings</h2>
         ...
         <button type="button" className="btn bg-zinc-300">Cancel</button>
         <button type="button" className="btn text-white btn-primary">Save</button>
         </div>
        </div>
      <ul className="flex space-x-6 mb-6">
        <Link to='/' className="font-semibold hover:text-[#232360] text-[#6A7181]">My details</Link>
        <Link to='/seting' className="font-semibold hover:text-[#232360] text-[#6A7181]">Profile</Link>
        <Link to='/seting' className="font-semibold hover:text-[#232360] text-[#6A7181]">Password</Link>
        ...
        <Link to='/' className="font-semibold hover:text-[#232360] text-[#6A7181]">Natification</Link>
      ...
      <form className="p-6 rounded-lg  space-y-4">
        <div className="flex  gap-7">
          <div>
            ...
            <input type="text" className="input input-bordered w-[19.25rem] h-[2.813rem]" placeholder="Killan" />
          </div>
          <div>
            <label className="block text-sm font-medium mb-3">Last name</label>
            <input type="text" className="input input-bordered w-[19.25rem] h-[2.813rem]" placeholder="James" />
          </div>
        </div> 
  ...
  <input type="text" className="grow" placeholder="killanjames@gmail.com" />
</div>
    ...
    <div className="mt-6">
            ...
            <input type="text" className="input input-bordered w-[19.25rem] h-[2.813rem]" placeholder="Product Designer" />
          </div>
